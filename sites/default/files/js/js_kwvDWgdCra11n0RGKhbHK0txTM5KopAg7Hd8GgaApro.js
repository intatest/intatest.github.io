...
Drupal.behaviors.initColorbox = {
  attach: function (context, settings) {
    ...
    $('.colorbox', context)
      .once('init-colorbox')
      .colorbox($.extend(settings.colorbox, {photo: true}));
